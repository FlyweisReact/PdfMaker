...
const App = () => {
  ...
  function TableGenerator () {
    const newTable = { productDesc , productQuan , productUnitPrice ,  }
  }
          ...
          <div className="Bordered">
            ...
            <div className="Invoice_Title">
              <div className="left">
                ...
                <p>
                  <strong>GSTIN - {InputChecker(companyGstIn, "Company GSTIN")} </strong>{" "}
                </p>
              </div>
              <div className="right">
                <p>
            ...
            <div className="Bill_To">
              ...
              <div className="Bill_To_Content">
                <p className="title"> {InputChecker(billTo, "Company Title")} </p>
                <span className="address">
                  <p>Address </p>
                  <p> : </p>
                  <p>
                  {InputChecker(billingAddress, "Address")}
                  </p>
                </span>
                <span className="GST">
