...
const App = () => {
  ...
  const generatePDF = () => {
    if(date && companyGstIn && taxInvoice && billTo && billingAddress && gstIn &&totalvalues && totalgst && invoiceValue && amountInWords && data.length > 0 && invoiceNumber ){
          ...
          <form>
            {minError ? (
              <Alert variant="danger">
                Total Price can't be less than Unit Price
              </Alert>
            ) : (
              ""
            )}
        ...
        <div id="pdfContent">
          ...
          <div className="Bordered">
            ...
            <div className="Invoice_Title">
              ...
              <div className="right">
                <p>{InputChecker(taxInvoice, "TAX INVOICE")}</p>
              </div>
            </div>
            ...
            <div className="Date">
              <div>
                ...
                <p>Invice# - {InputChecker(invoiceNumber, "Invice")}</p>
              </div>
            </div>
